...
import { MatFormField } from '../../../../lib/form-field';
import { MAT_INPUT_VALUE_ACCESSOR } from '../../../../lib/input';
...
export class NgxMatDatetimeInput<D> implements ControlValueAccessor, OnDestroy, Validator {
    ...
    _onInput(value: string) {
        ...
        const isSameTime = date && this._value ? this._dateAdapter.isSameTime(date, this._value) : false;
