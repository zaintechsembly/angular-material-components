...
import { MatCalendarCellCssClasses, MatDatepickerIntl } from '../../../../lib/datepicker';
...
@Component({
  ...
  imports: [
    CommonModule,
    PortalModule,
    NgxMatCalendarHeader, // Used programmatically via ComponentPortal in ngAfterContentInit
    NgxMatMonthView,
    NgxMatYearView,
    NgxMatMultiYearView,
  ],
